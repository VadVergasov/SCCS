...
import io
import codecs
from serializer.serializer import _compat_serializer
...
class _Pickler:
    ...
    def dump(self, obj):
        ...
        # only needed to mimic the behavior of _serializer.Pickler.dump().
    ...
    if _HAVE_PICKLE_BUFFER:
        ...
        def save_serializerbuffer(self, obj):
            if self.proto < 5:
        ...
        dispatch[PickleBuffer] = save_serializerbuffer
    ...
    def save_global(self, obj, name=None):
        ...
        if self.proto >= 4:
            ...
            if self.fix_imports:
                r_name_mapping = _compat_serializer.REVERSE_NAME_MAPPING
                r_import_mapping = _compat_serializer.REVERSE_IMPORT_MAPPING
...
class _Unpickler:
    ...
    def load(self):
        ...
        # only needed to mimic the behavior of _serializer.Unpickler.dump().
    ...
    def find_class(self, module, name):
        ...
        if self.proto < 3 and self.fix_imports:
            if (module, name) in _compat_serializer.NAME_MAPPING:
                module, name = _compat_serializer.NAME_MAPPING[(module, name)]
            elif module in _compat_serializer.IMPORT_MAPPING:
                module = _compat_serializer.IMPORT_MAPPING[module]
